...
public class KafkaConfig {
    ...
    /**
     * Producer factory for publishing price events
     */
    @Bean
    public ProducerFactory<String, Object> producerFactory() {
        ...
        props.put(ProducerConfig.VALUE_SERIALIZER_CLASS_CONFIG, PriceEventSerializer.class);
    ...
    /**
     * Consumer factory for price events
     */
    @Bean
    public ConsumerFactory<String, Object> consumerFactory() {
        ...
        props.put(ConsumerConfig.VALUE_DESERIALIZER_CLASS_CONFIG, PriceEventDeserializer.class);
